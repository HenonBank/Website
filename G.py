...
# -*- coding: utf-8 -*-
"""
GitHub Script Runner - Серверная часть (API)
Загружает скрипты из GitHub, устанавливает зависимости и запускает на сервере
"""
...
def install_dependencies(code):
    ...
    if not to_install:
        return {"status": "info", "message": f"Все зависимости установлены: {', '.join(packages)}", "installed": []}
...
if __name__ == '__main__':
    print("""
    ╔═══════════════════════════════════════════════════════════════╗
    ║           GitHub Script Runner — Серверная часть              ║
    ║   API для загрузки, установки и запуска Python скриптов      ║
    ╚═══════════════════════════════════════════════════════════════╝
    """)
    ...
    print("   GET  /api/script/<name>/content - Содержимое")
    print("   POST /api/script/<name>/update  - Обновить")
    print("   GET  /api/script/<name>/log     - Лог")
    print("   POST /api/sync             - Синхронизация с GitHub")
    print("   POST /api/push             - Отправить файл в GitHub")
